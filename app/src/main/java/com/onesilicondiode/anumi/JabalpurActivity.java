...
public class JabalpurActivity extends AppCompatActivity {
    ...
    private static final int DAY_START_HOUR = 12;
    private static final int DAY_END_HOUR = 15;
    private static final int AFTERNOON_START_HOUR = 16;
    ...
    private static final int NIGHT_START_HOUR = 22;  // Midnight
    ...
    private void checkDialog() {
        if (!isDialogShown()) {
            ...
            new MaterialAlertDialogBuilder(this)
                    ...
                    .setCancelable(false)
                    .setMessage(R.string.jabalpur_desc)
    ...
    private void showLocationChoiceDialog() {
        new MaterialAlertDialogBuilder(this)
                ...
                .setPositiveButton("Baaghban Nagar", (dialog, which) -> {
                    ...
                    Intent intent = new Intent(JabalpurActivity.this, BaaghbanNagarActivity.class);
                    startActivity(intent);
                    finish();
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                })
                .setNegativeButton("Starry Sky", (dialog, which) -> {
                    // Save the selected location to SharedPreferences
                    String selectedLocation = "Starry Sky";
                    saveLocationPreference(selectedLocation);

                    // Intent to the Jabalpur activity
                    Intent intent = new Intent(JabalpurActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                    overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                })
    ...
    private void goToLock() {
        ...
        getSharedPreferences(APP_LOCK, MODE_PRIVATE).edit()
                ...
                .apply();
        Intent toLock = new Intent(JabalpurActivity.this, LockApp.class);
    ...
    private void performReadTextFile() {
        ...
        Future<String> future = executorService.submit(new JabalpurActivity.ReadTextFileTask());
    ...
    private class FetchTextTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null && !result.isEmpty()) {
                ...
                Toast.makeText(JabalpurActivity.this, "Failed to Fetch What's New", Toast.LENGTH_SHORT).show();
            }
        }
